...
var nodeTools = []toolDef{
	readTool("node", "node_status",
		...
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchNodeStatus(ctx) }),
	...
	readTool("node", "node_blockchain_info",
		...
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchBlockchainInfo(ctx) }),
	readTool("node", "node_network",
		"Get network info: peer count and network hashrate.",
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchNetworkInfo(ctx) }),
	readTool("node", "node_peers",
		"List the dcrd node's currently connected peers.",
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchPeers(ctx) }),
	readTool("node", "node_supply",
		"Get the Decred coin supply overview (circulating, staked, treasury, mixed percentage).",
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchSupplyInfo(ctx) }),
	readTool("node", "node_staking_overview",
		...
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchStakingInfo(ctx) }),
	readTool("node", "node_mempool",
		"Get current mempool info (transaction count, size in bytes).",
		func(ctx context.Context, _ emptyInput) (any, error) { return services.FetchMempoolInfo(ctx) }),
}
