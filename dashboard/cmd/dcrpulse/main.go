...
func main() {
	...
	api.HandleFunc("/wallet/governance/votetrickle/events", handlers.StreamVoteTrickleEventsHandler).Methods("GET")
	...
	api.HandleFunc("/br/store/files/list", handlers.BisonrelayStoreFilesListHandler).Methods("GET")
	api.HandleFunc("/br/store/files/get", handlers.BisonrelayStoreFileGetHandler).Methods("GET")
	api.HandleFunc("/br/store/files/delete", handlers.BisonrelayStoreFileDeleteHandler).Methods("POST")
	...
	api.HandleFunc("/br/contacts/groups", handlers.BisonrelayContactGroupsHandler).Methods("GET", "POST")
	api.HandleFunc("/br/contacts/groups/assign", handlers.BisonrelayContactGroupAssignHandler).Methods("POST")
	api.HandleFunc("/br/contacts/groups/settings", handlers.BisonrelayContactGroupSettingsHandler).Methods("POST")
	...
	api.HandleFunc("/wallet/ln/liquidity/confirm", handlers.LightningLiquidityConfirmHandler).Methods("POST")
	api.HandleFunc("/wallet/ln/liquidity/confirm/pending", handlers.LightningLiquidityConfirmPendingHandler).Methods("GET")
	api.HandleFunc("/wallet/ln/liquidity/confirm/events", handlers.StreamLiquidityConfirmEventsHandler).Methods("GET")
	...
	api.HandleFunc("/msig/wallets/restore", handlers.MsigRestoreHandler).Methods("POST")
	api.HandleFunc("/msig/proposals/propose", handlers.MsigProposeHandler).Methods("POST")
	api.HandleFunc("/msig/proposals/sign", handlers.MsigSignHandler).Methods("POST")
	api.HandleFunc("/msig/proposals/reject", handlers.MsigRejectHandler).Methods("POST")
	api.HandleFunc("/msig/proposals/abort", handlers.MsigAbortHandler).Methods("POST")
	...
	api.HandleFunc("/msig/outbox", handlers.MsigManualOutboxHandler).Methods("GET")
	api.HandleFunc("/msig/outbox/done", handlers.MsigManualDoneHandler).Methods("POST")
	api.HandleFunc("/msig/import", handlers.MsigImportHandler).Methods("POST")
